...
UILabel::UILabel(
    ...
    glm::vec2 position) : UIElement(std::move(position)), m_textRenderer(textRenderer), m_text(text), m_fontID(fontID), m_fontSize(fontSize), m_textFColor(std::move(textColor)) {
    // 获取文本渲染尺寸
